...
% Security
As the implemented medical information system (Section~\ref{sec:impl}) is only exemplary and the stored medical data is randomly generated without any connection to
...
% criticism umls sim
The implemented information system demonstrates the capabilities of similarity-based (Section~\ref{sec:meth_sbqa}) and flexible query answering 
...
\citetalias{UMLS::Sim} measure \citep{McInnes2009} is sufficient to demonstrate the power and efficiency of similarity-based query answering in combination 
